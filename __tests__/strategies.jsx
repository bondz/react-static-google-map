...
describe("Marker Strategy", () => {
  test("MarkerStrategy is defined", () => {
    ...
    expect(MarkerStrategy(<Marker location="test" />)).toBe("markers=size:normal%7Ctest");
  });

  test("location prop is required", () => {
    expect(() => MarkerStrategy(<Marker />)).toThrow("Marker expects a valid location");
  });
  ...
  test("Marker group passes on all props from children except location", () => {
    ...
    const wrapper = MarkerGroupStrategy(
      <Group size="tiny" color="blue" label="G" iconURL="testIcon" anchor="topleft">
...
describe("Path Strategy", () => {
  ...
  test("points prop is required", () => {
    expect(() => PathStrategy(<Path />)).toThrow("Path expects a valid points prop");
  });
...
describe("Directions Strategy", () => {
  ...
  test("origin prop is required", () => {
    expect(() => DirectionStrategy(<Direction />)).toThrow("Origin prop is required");
  });
